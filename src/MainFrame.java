...
public class MainFrame {
	...
	public void setRemoteDevices(RemoteDevice[] newDevices){
		ConnectableList = newDevices;
	}

	public RemoteDevice[] getRemoteDevices(){
		return this.ConnectableList;
	}
	...
	private void launchDisplay() {
		...
		JButton but3 = new JButton("Send 1...");
		frame = new JFrame();
		...
		sortPanel = new JPanel(new GridLayout(0,3));
		...
		but1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				setRemoteDevices(ConnectableList);
			}
		});
		...
		but2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println(getRemoteDevices()[list.getSelectedRow()].getBluetoothAddress());
				bluetoothConnector.connectDevice();

			}
		});

		// button 3 will connect to send data
		but3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				
				bluetoothConnector.send();
	...
	public class bluetoothConnector{
		...
		public RemoteDevice[] refreshList(){
			try{
				...
				uuidSet[0]=new UUID(0x1101); //SPP service
		...
		public void connectDevice(){
			String URL = bluetoothListener.URLs.get(list.getSelectedRow());
			bluetoothListener.connectToDevice(URL, getRemoteDevices()[list.getSelectedRow()]);

		}
		
		public void send(){
			bluetoothListener.send();
